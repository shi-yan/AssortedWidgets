...
namespace OGLFT {
  ...
  struct Advance {
    ...
    Advance ( FT_Vector v )
    {
      dx_ =static_cast<float>(v.x / 64.);
      dy_ =static_cast<float>(v.y / 64.);
    }
  ...
  struct BBox {
    ...
    {
      x_min_ =static_cast<float>(ft_bbox.xMin / 64.);
      y_min_ =static_cast<float>(ft_bbox.yMin / 64.);
      x_max_ =static_cast<float>(ft_bbox.xMax / 64.);
      y_max_ =static_cast<float>(ft_bbox.yMax / 64.);
    }
    ...
    {
      x_min_ *= static_cast<float>(k);
      y_min_ *= static_cast<float>(k);
      x_max_ *= static_cast<float>(k);
      y_max_ *= static_cast<float>(k);
      advance_.dx_ *= static_cast<float>(k);
      advance_.dy_ *= static_cast<float>(k);
